...
file_dir_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "files")

LABEL_SRC = os.path.join(file_dir_path, "vision", "class_descriptions.csv")
OBJECT_SRC = os.path.join(file_dir_path, "vision", "object_descriptions.csv")
MAP_SRC = os.path.join(file_dir_path, "vision", "mid2datawiki.csv")
WIKINAME_SRC = os.path.join(file_dir_path, "vision", "datawiki2name.cache")
KGN_SRC = os.path.join(file_dir_path, "vision", "kg_neighbors.cache")
KGP_SRC = os.path.join(file_dir_path, "vision", "kg_parents.cache")
KGW_SRC = os.path.join(file_dir_path, "vision", "kg_whole.cache")
TEXT_CLASS_SRC = os.path.join(file_dir_path, "language/category_list.txt")

LOG_SRC = os.path.join(os.path.dirname(os.path.dirname(os.path.realpath(__file__))), "execution_logs")


#=======================================
#= Some information of Google Cloud AI =
#=======================================
...
Speech_API = ["recognize", "long_running_recognize", "streaming_recognize"]
